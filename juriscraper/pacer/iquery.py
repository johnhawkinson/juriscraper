...
class iQueryReport(BaseDocketReport, BaseReport):
    ...
    def __init__(self, court_id, pacer_session=None):
        super(iQueryReport, self).__init__(court_id, pacer_session)
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python -m juriscraper.pacer.iquery filepath")
